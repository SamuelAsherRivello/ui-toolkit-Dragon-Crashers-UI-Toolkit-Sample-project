...
namespace UIToolkitDemo
{
    ...
    public class PopUpText : MenuScreen
    {
        ...
        LocalizedString m_InsufficientFundsLocalized = new LocalizedString 
        { 
        ...
        LocalizedString m_GearEquippedLocalized = new LocalizedString 
        { 
            TableReference = "SettingsTable",
        ...
        LocalizedString m_InsufficientPotionsLocalized = new LocalizedString 
        { 
            TableReference = "SettingsTable",
        ...
        LocalizedString m_ItemAddedLocalized = new LocalizedString 
        { 
            TableReference = "SettingsTable",
        ...
        LocalizedString m_PotionsAddedLocalized = new LocalizedString 
        { 
            TableReference = "SettingsTable",
