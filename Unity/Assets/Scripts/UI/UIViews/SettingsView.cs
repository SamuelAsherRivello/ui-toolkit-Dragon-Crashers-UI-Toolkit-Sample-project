...
namespace UIToolkitDemo
{
    ...
    public class SettingsView : UIView
    {
        ...
        void UpdateLocalizedText()
        {
            ...
            {
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_ThemeDropdown_Option1"),
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_ThemeDropdown_Option2"),
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_ThemeDropdown_Option3")
            };
            UpdateDropdownChoices(m_ThemeDropdown, themeChoices, m_LocalUISettings.Theme, ThemeOptionKeys);

            // Get localized names for languages using the correct keys from your localization table
            string[] languageChoices = new string[]
            {
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_LanguageDropdown_English"),
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_LanguageDropdown_Spanish"),
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_LanguageDropdown_French"),
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_LanguageDropdown_Danish")
            };
            
            UpdateDropdownChoices(m_LanguageDropdown, languageChoices, m_LocalUISettings.LanguageSelection, LanguageKeys);

            // Update the on/off Slide Toggle labels
            string onLabel =
                
                m_SlideToggle.OffLabel =
                LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_FpsSlideToggle_Off");
            
            m_SlideToggle.OnLabel = LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_FpsSlideToggle_On");
            ...
            radioButtons[0].text = LocalizationSettings.StringDatabase.GetLocalizedString("SettingsTable", "Settings_FrameRateRadioButtons_Max");
        }
        ...
        /// <summary>
        /// Updates the choices of a <see cref="DropdownField"/> with localized strings.
        /// </summary>
        /// <param name="dropdown">The dropdown field to update.</param>
        /// <param name="localizedChoices">An array of localized choice strings.</param>
        void UpdateDropdownChoices(DropdownField dropdown, string[] localizedChoices, string currentValue, string[] optionKeys)
        {
            if (dropdown == null)
                return;
            ...
            int savedIndex = Array.IndexOf(optionKeys, savedValue);
