...
namespace UIToolkitDemo
{
    public class InventoryView : UIView
    {
        ...
        void UpdateLocalizedText()
        {
            ...
            UpdateDropdownChoices(m_InventoryRarityDropdown, rarityChoices, RarityKeys[m_InventoryRarityDropdown.index], RarityKeys);

            // Update Slot Type dropdown
            ...
            UpdateDropdownChoices(m_InventorySlotTypeDropdown, slotTypeChoices, SlotTypeKeys[m_InventorySlotTypeDropdown.index], SlotTypeKeys);
        }
